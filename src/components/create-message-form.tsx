...
export function CreateMessageForm() {
  ...
  async function createMessageAction(data: FormData) {
    ...
    try{
        ...
        toast.error("Houve um erro ao criar a pergunta. Tente novamente")
    }

  }

  return (
    <form action={createMessageAction} className="w-full flex items-center gap-2 bg-zinc-900 p-2 rounded-xl border border-zinc-800 ring-orange-400 ring-offset-0 ring-offset-zinc-900 focus-within:ring-1">
      <input
        type="text"
        name="message"
